  ...
  <div class="wrap"> <!--WRAP-->
    <div class="grids"> <!--GRIDS-->
      ...
      <div class="grid-12 mL">
        ...
        <div class="grid-10">
          <h1 title="Activities" style="margin-top:0;">Adminarea</h1>
        </div>
...
EOF;
              ...
              if(!$ret){
                ...
                //echo "<script>setTimeout(function(){location.reload(true)}, 1500);</script>";
              }
              //$db->close();
            }// fin del if addtask
...
EOF;
                      ...
                      if(!$ret){
                        ...
                        $mysuccess = " Record(s) updated successfully.\n";
                      }
                      $i++;
                    } //cierra mi while
                    //$db->close();
                    echo $mysuccess;
                    //echo "<script>setTimeout(function(){location.reload(true)}, 1200);</script>";
                  }else{
              ?>
...
EOF;
          ...
          ?>
              </div> <!-- termina div midtext -->
        </div><!-- termina div gri12 box solid -->
      </div> <!-- termina grid12 mL -->
